const contractAddress = "0x5827E6cb2EA599C376b1c6BeEB20adE4b050FA39"; //Replace with your own contract address
const chain = 'polygon'; // rinkeby or polygon

const welcome_h1 = "Welcome to Bored Bunnys Club NFT Project!!";
const welcome_h2 = "Connect to MetaMask to Get Started";
const welcome_p = 'These guys are certainly here to stay. Follow us on twitter and join our facebook group, Links can be found on twitter and facebook. 40% of profits will be going back to the holders, $20,000 giveaway. We use Polygon for the simple fact our collecters wont be charged high gas fees :)';
...
const p_public_mint = "These guys are certainly here to stay. Follow us on twitter and join our facebook group, Links can be found on twitter and facebook. 40% of profits will be going back to the holders, $20,000 giveaway. We use Polygon for the simple fact our collecters wont be charged high gas fees! 🎉";
